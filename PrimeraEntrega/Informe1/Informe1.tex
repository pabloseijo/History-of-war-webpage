...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Esquemas/Arquitectura de Informacion.jpg}
...
\begin{figure}[H]
    \centering
    \hspace*{-3.5cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.6\textwidth]{Esquemas/CasosDeUsoSegmentado(1).jpg}
...
\begin{figure}[H]
    \centering
    \hspace*{-3.5cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.6\textwidth]{Esquemas/CasosDeUsoSegamentado(2).jpg}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Storyboards/StoryBoard_seleccion_batalla.png}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Storyboards/StoryBoard_seleccion_libro.png}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Storyboards/StoryBoard_seleccion_guerra.png}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Storyboards/StoryboardPersonaje.jpg}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Storyboards/StroryBoardInicioSesion.jpg}
...
\begin{figure}[H]
    \centering
    \hspace*{-3cm} % Ajusta este valor según sea necesario
    \includegraphics[width=1.5\textwidth]{Esquemas/EstructuraDeFicheros.jpg}
